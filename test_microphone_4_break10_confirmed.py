...
def playback_thread():
    global nihao_detected, xiaoqi_detected, player2,message_id, \
        ...
        play_haode,audio_file_stack_length,xiaoqi_event,play_haode_event,recording_event,shield_after_send,flag_think
  ...
  # 清除事件信号
    while running2:
        ...
        if len(output_audio_stack) > 0 :
            ...
            # flag_think=False
            if shield_after_send==False and (no_match_but_valid or nihao_detected or xiaoqi_detected or audio_file_stack_length > 1):
            ...
            try:
                while True:
                    ...
                    # 检查中断信号
                    if shield_after_send==False and (recording_event.is_set() or xiaoqi_event.is_set() or nihao_detected or xiaoqi_detected or no_match_but_valid or audio_file_stack_length > 1):
                        print("$$$$$$$$$$$$$$$$$")
