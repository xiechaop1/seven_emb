    ...
    with sd.RawInputStream(samplerate=args.samplerate, blocksize=4000, device=args.device,
        ...
        while True:
            ...
            if rec.AcceptWaveform(data):
                ...
                if 'alternatives' in result_dict and len(result_dict['alternatives']) > 0:
                    print("识别结果：", result_dict['alternatives'][0]['text'])

                text_content = result_dict['alternatives'][0]['text']
                print(text_content)
