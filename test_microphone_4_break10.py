...
def playback_thread():
    global nihao_detected, xiaoqi_detected, player2,message_id, \
        ...
        play_haode,audio_file_stack_length,xiaoqi_event,play_haode_event,recording_event
        ...
        if len(output_audio_stack) > 0 :
            ...
            try:
                while True:
                    ...
                    # 检查中断信号
                    if recording_event.is_set() or xiaoqi_event.is_set() or nihao_detected or xiaoqi_detected or no_match_but_valid or audio_file_stack_length > 1:
                        print("$$$$$$$$$$$$$$$$$")
...
def callback(indata, frames, time1, status):
    ...
    global t_play_haode,output_file_name, recording, silence_counter, output_pcm_file, pre_buffer, audio_file_stack, \
        ...
        is_silent_flag,recording_event
