...
class AddAlarmDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.repeat_combo.setStyleSheet("color: #d1d1d6; background: #18181a; width: 200px; font-size: 18px; border: none; padding: 8px 0 8px 0;")
        self.sound_combo = QComboBox()
        self.sound_combo.addItems(["None", "Soft", "Active"])
        self.sound_combo.setStyleSheet("color: #d1d1d6; background: #18181a; width: 200px; font-size: 18px; border: none; padding: 8px 0 8px 0;")
        self.light_combo = QComboBox()
        self.light_combo.addItems(["None", "Breathing", "Colorful"])
        self.light_combo.setStyleSheet("color: #d1d1d6; background: #18181a; width: 200px; font-size: 18px; border: none; padding: 8px 0 8px 0;")
        self.screen_combo = QComboBox()
        self.screen_combo.addItems(["None", "Sunrise", "Sunset", "Moon"])
        self.screen_combo.setStyleSheet("color: #d1d1d6; background: #18181a; width: 200px; font-size: 18px; border: none; padding: 8px 0 8px 0;")
